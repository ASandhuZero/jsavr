RAM_address = {
	// regex search string: .equ\t*\s*([0-9a-zA-Z_]+)*\t*\s*=\t*\s*([0-9]+[x]*[A-F0-9]*)*
	...
	"TOIE3": 0, // Timer/Counter2 Overflow Interrupt Enable
	"OCIE3A": 1, // Timer/Counter2 Output Compare Match A Interrupt Enable
	"OCIE3B": 2, // Timer/Counter2 Output Compare Match B Interrupt Enable

	// TIFR3 - Timer/Counter Interrupt Flag register
	"TOV3": 0, // Timer/Counter2 Overflow Flag
	"OCF3A": 1, // Output Compare Flag 2A
	"OCF3B": 2, // Output Compare Flag 2B
	...
	// TCCR3C - Timer/Counter1 Control Register C
	...
	// ***** TC4 *****************
	// TIMSK4 - Timer/Counter Interrupt Mask Register
	"TOIE4": 0, // Timer/Counter2 Overflow Interrupt Enable
	"OCIE4A": 1, // Timer/Counter2 Output Compare Match A Interrupt Enable
	"OCIE4B": 2, // Timer/Counter2 Output Compare Match B Interrupt Enable

	// TIFR4 - Timer/Counter Interrupt Flag register
	"TOV4": 0, // Timer/Counter2 Overflow Flag
	"OCF4A": 1, // Output Compare Flag 2A
	"OCF4B": 2, // Output Compare Flag 2B
